      ...
      <section style={{ backgroundColor: 'var(--color-surface)', borderTop: '4px solid #eab308' }}>
        <div className="container" style={{ display: 'flex', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 350px', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '2.5rem 3rem', backgroundColor: 'var(--color-primary)', borderLeft: '1px solid rgba(255,255,255,0.1)' }}>
             ...
             <a href="mailto:service@urbanproplumbing.com.au" style={{ color: '#eab308', display: 'flex', alignItems: 'center', gap: '1rem', fontSize: '1.05rem', fontWeight: 600, textDecoration: 'none', transition: 'opacity 0.3s ease' }}>
