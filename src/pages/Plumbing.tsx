      ...
      <section style={{ backgroundColor: 'var(--color-bg)' }}>
        ...
        <div style={{ 
          ...
          <style>{`
            ...
            .access-link:hover .link-icon { transform: scale(1.15); }
          ...
          <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '2rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                <span style={{ fontSize: '0.85rem', fontWeight: 900, letterSpacing: '0.3em', textTransform: 'uppercase', color: 'var(--color-accent)' }}>
                  Live Dispatch
                </span>
